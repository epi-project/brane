...
pub enum GenerateError {
    ...
    FileBodyWriteError{ what: &'static str, path: PathBuf, err: brane_cfg::config::YamlError },
...
pub enum LifetimeError {
    ...
    ProxyReadError{ err: brane_cfg::config::YamlError },
...
pub enum UnpackError {
    ...
    NodeConfigError{ err: brane_cfg::config::YamlError },
