...
impl Address {
    ...
    pub fn ipv4(b1: u8, b2: u8, b3: u8, b4: u8, port: u16) -> Self {
        Self::Ipv4(std::net::Ipv4Addr::new(b1, b2, b3, b4), port)
    }
    /// Constructor for the Address that initializes it for the given IPv4 address.
    /// 
    /// # Arguments
    ...
    /// A new Address instance.
    #[inline]
    pub fn from_ipv4(ipv4: impl Into<std::net::Ipv4Addr>, port: u16) -> Self {
    ...
    /// A new Address instance.
    #[inline]
    pub fn from_ipv6(ipv6: impl Into<std::net::Ipv6Addr>, port: u16) -> Self {
